---
{"dg-publish":true,"permalink":"/readme-he-thong/","title":"🌊 README — Trung tâm điều khiển Web ETZ","dg-note-properties":{"title":"🌊 README — Trung tâm điều khiển Web ETZ","version":"10.2","last_updated":"2026-05-27"}}
---
...
> Hệ thống đang vận hành theo **kiến trúc Hybrid 3+1 v10.2** — tích lũy tri thức bền vững.
...
| 🏛️ **Phiên bản Bộ luật** | v10.2 (2026-05-27) |
| 🗺️ **Bản đồ hệ thống** | ✅ [[00_BO_NAO_AI_INTERNAL/03_System_Config/MAP\|MAP]] |
| 📂 **Phòng ban WIKI (L2)** | 12 thư mục |
| 🧠 **Entity SUMMARY (L3)** | 4 file (Freelancer, KeToan, Viettel Post, SD_Authentication) |
| 🐍 **Bộ Script ingest** | 8 script |
| 💾 **Backup version** | v9.5, v10.0, v10.1 (đã lưu trữ) |
...
> 📖 Xem đầy đủ tại [[00_BO_NAO_AI_INTERNAL/03_System_Config/PROJECT_INSTRUCTIONS\|PROJECT_INSTRUCTIONS]] § III.
...
| :--- | :--- | :--- |
| 🏛️ **Luật tối cao** | [[00_BO_NAO_AI_INTERNAL/03_System_Config/PROJECT_INSTRUCTIONS\|PROJECT_INSTRUCTIONS]] | Quy chuẩn vận hành |
| 🗺️ **Bản đồ** | [[00_BO_NAO_AI_INTERNAL/03_System_Config/MAP\|MAP]] | Cây thư mục + ánh xạ |
| 📋 **Mục lục AI** | [[00_BO_NAO_AI_INTERNAL/03_System_Config/INTERNAL_INDEX\|INTERNAL_INDEX]] | FLAT list cho AI quét |
| 📊 **Dashboard Sếp** | [[index\|index]] | Giao diện báo cáo |
| 📝 **Nhật ký** | [[01_TONG_QUAN_LY_DU_AN/log\|log]] | Log thao tác |
