...
|---|---|---|---|
| **Chành xe** | Sau khi tạo mã BH, xuất HĐ & Phiếu xuất kho ngay. | **Bắt buộc** kèm HĐ & Phiếu xuất kho. Giao xong chụp ảnh biên nhận báo ngay cho Admin. | **Thủ công:** Upload ảnh lên Web. **Quy tắc 2 ngày:** Tự động hoàn tất nếu khách không khiếu nại. |
